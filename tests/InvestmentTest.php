...
class InvestmenTest extends TestCase
{
    ...
    public function testInterestCalculateOne(){
        $investment = new Investment(new Investor('Investor 1', 1000), 1000, new DateTime('2015-10-03'));
    ...
    public function testInterestCalculateTwo(){
        $investment = new Investment(new Investor('Investor 3', 1000), 500, new DateTime('2015-10-10'));
